...
class MarketbenchmarkController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('back-office.settings.marketbenchmark.index');
    }
    ...
    {
        return view('back-office.settings.marketbenchmark.create');
    }
}
