...
class GisMapSourceController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('back-office.settings.gismapsource.index');
    }
    ...
    {
        return view('back-office.settings.gismapsource.create');
    }
}
